...
const randomDonors = [
    ...
    { email: 'anne****@yahoo.com', amount: '1$' },
    { email: 'book*****@outlook.com', amount: '1$' },
    { email: 'redo*****@proton.me', amount: '2$' },
    { email: 'jedr*******@proton.me', amount: '1$' },
    { email: 'jerr*****@proton.me', amount: '1$' },
    { email: 'rhea********@proton.me', amount: '3$' },
    { email: 'renn******@proton.me', amount: '1$' },
    { email: 'lot0***@proton.me', amount: '1$' },
    { email: 'pedr***********@proton.me', amount: '2$' },
    { email: 'jean***@proton.me', amount: '1$' },
    { email: 'hele*****@proton.me', amount: '2$' },
    { email: 'brya*********@proton.me', amount: '1$' },
    { email: 'mrry*****@proton.me', amount: '1$' },
    { email: 'spee************@proton.me', amount: '1$' },
    { email: 'chas******@proton.me', amount: '2$' },
    { email: 'luna*****@proton.me', amount: '2$' },
    { email: 'ar4r*******@proton.me', amount: '1$' },
    { email: 'alce**********@proton.me', amount: '1$' },
    { email: 'albe******@proton.me', amount: '1$' },
    { email: 'vinc******@proton.me', amount: '2$' },
    { email: 'r1ta*********@proton.me', amount: '1$' },
    { email: 'arj0*******@proton.me', amount: '2$' },
    { email: 'zyel*********@proton.me', amount: '10$' },
    { email: 'aler************@proton.me', amount: '2$' },
    { email: 'raul*********@proton.me', amount: '2$' },
    { email: 'step*******@proton.me', amount: '2$' },
    { email: 'less*****@proton.me', amount: '1$' },
    { email: 'jayr*********@proton.me', amount: '3$' },
    { email: 'benn*****@proton.me', amount: '3$' },
    { email: 'kunn********@proton.me', amount: '2$' },
    { email: 'rent*******@proton.me', amount: '3$' },
    { email: 'faus**********@proton.me', amount: '2$' },
    { email: 'brad*****@proton.me', amount: '1$' },
    { email: 'becj****@proton.me', amount: '2$' },
    { email: 'rick*********@proton.me', amount: '2$' },
    { email: 'meno*******@proton.me', amount: '2$' },
    { email: 'donn**********@proton.me', amount: '1$' },
    { email: 'boss*************@proton.me', amount: '2$' },
    { email: 'youk*****@proton.me', amount: '2$' },
    { email: 'liza*********@proton.me', amount: '1$' },
    { email: 'cris******@proton.me', amount: '1$' },
    { email: 'alle*****@proton.me', amount: '2$' },
    { email: 'erne*********@proton.me', amount: '1$' },
    { email: 'marv******@proton.me', amount: '1$' },
    { email: 'clar******@proton.me', amount: '1$' },
    { email: 'axce*********@proton.me', amount: '1$' },
    { email: 'carl*******@proton.me', amount: '1$' },
    { email: 'l152*****@proton.me', amount: '2$' },
    { email: 'robb***@proton.me', amount: '1$' },
    { email: 'bren********@proton.me', amount: '2$' },
    { email: 'shei*****@proton.me', amount: '2$' },
    { email: 'shen*******@proton.me', amount: '1$' },
    { email: 'nanc**********@proton.me', amount: '1$' },
    { email: 'josh*****@proton.me', amount: '1$' },
    { email: 'josi***@proton.me', amount: '2$' },
    { email: 'jhos***@proton.me', amount: '1$' },
